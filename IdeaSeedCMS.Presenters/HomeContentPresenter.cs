...
{
    public class HomeContentPresenter : Presenter
    {
        IHomeContentView _view;

        public HomeContentPresenter(IHomeContentView view, ISessionProvider session)
            : base(view, session)
        {
            _view = base.GetView<IHomeContentView>();
